                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="relative">
                                ...
                                <x-text-input
                                    ...
                                    name="prenom"
                                    :value="old('prenom')"
                                    class="w-full pl-10 pr-3 py-2 border rounded-lg focus:ring-1 focus:ring-blue-500"
                                    required
                                    autofocus />
                            </div>
                            <x-input-error :messages="$errors->get('prenom')" class="mt-1 text-xs" />
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <x-input-error :messages="$errors->get('nom')" class="mt-1 text-xs" />
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <x-input-error :messages="$errors->get('telephone')" class="mt-1 text-xs" />
                        </div>
                    ...
                    <p class="text-center text-xs text-gray-500 mt-3">
                        Accès existant ?
                        <a href="{{ route('login') }}" class="text-blue-600 hover:underline">Connexion Super Admin</a>
                    </p>
                </form>
            </div>
        </div>
