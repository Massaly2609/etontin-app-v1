                        ...
                        <form action="{{ route('settings.updateNotifications') }}" method="POST">
                            ...
                            <div class="space-y-4">
                                <div class="form-check">
                                    <input type="checkbox" name="notifications[]" value="email" {{ in_array('email', $activeNotifications) ? 'checked' : '' }} class="form-check-input">
                                    <label class="form-check-label">Notifications par Email</label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" name="notifications[]" value="sms" {{ in_array('sms', $activeNotifications) ? 'checked' : '' }} class="form-check-input">
